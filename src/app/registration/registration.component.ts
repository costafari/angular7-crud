...
export class RegistrationComponent implements OnInit {
  ...
  countries: string[] = ['US', 'UK', 'India', 'UAE', 'El Salvador'];
  ...
  constructor() {
      ...
      this.registrations.push(new Registration('Salvador', 'Ceren', {year: 1910, month: 6, day: 14}, 'chambaceren@aol.com', 'salva123', 'El Salvador'));
   }
